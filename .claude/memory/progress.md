...
>
> **check:claims 逐條處置**(base=`4877792`、cumulative 至 tip `4fbc8db` 實測 397 added lines / 0 hits;本 bookkeeping fix commit 後重測會微幅變、以 final tip 為準):D9 anti-overclaim 全程守、code 修法 wording 未新增絕對化宣稱。
>
