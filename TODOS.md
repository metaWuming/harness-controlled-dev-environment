...
### 🟢 P2#3 Step 5 defer 集合(check-mutation-specs 邊角,12 條 INFORMATIONAL conf ≤8;①②③④⑤⑥⑦⑧⑨⑩⑪⑫⑬⑭ 交付或決策 14 條(含 ④ WONTFIX 決策記錄、非 code 交付),剩 1 條:⑮)
