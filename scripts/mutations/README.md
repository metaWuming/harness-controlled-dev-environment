...
- `mutation-spec-discovery.json` — 7 條探針(P2#3 defer ⑤),守 `check-mutation-specs.ts` 的 discovery 契約:遞迴 / case-insensitive / 副目錄 symlink dir 靜默略過 / collision 大小寫 fail-open / collision basename 誤判 / POSIX 排序 / recursive 0-spec
